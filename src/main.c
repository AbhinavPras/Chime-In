...
//Use this function to measure the tine between two events
    //Read it once at the beginning of the event, and then once at the end, and measure the difference
